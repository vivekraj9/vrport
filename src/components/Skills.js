...
const Skills =({name, x, y}) => {
  return (
    ...
    ">
      ...
      <Skill name="Python" x="-32vw" y="6vw" />
      <Skill name="JavaScript" x="-30vw" y="-9vw" />
      <Skill name="Tailwind CSS" x="0vw" y="-22vw" />
      

      <Skill name="Bootstrap" x="30vw" y="-9vw" />

      <Skill name="Express" x="-1vw" y="15vw" />
